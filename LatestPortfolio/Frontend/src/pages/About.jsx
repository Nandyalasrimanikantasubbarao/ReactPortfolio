import AboutSpline from "../Components/Spines/AboutSpline";
    ...
    <section className="relative z-20 -mt-[95px] h-[50rem] overflow-hidden bg-amber-400">
      ...
      <div className="grid h-40 grid-cols-2">
        ...
        <div className="relative">
          <p className="-z-10 row-span-2 mr-5 overflow-auto p-5 text-2xl font-medium leading-relaxed text-white">
